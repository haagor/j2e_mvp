...
public class IS3000PublicAPI {

	public CartWebService carts;
	public CustomerCareService ccs;


	public IS3000PublicAPI(String host, String port) {
		initCart(host, port);
	}

	private void initCart(String host, String port) {
		URL wsdlLocation = IS3000PublicAPI.class.getResource("/CartWS.wsdl");
	...
	private void initCCS(String host, String port) {
		URL wsdlLocation = IS3000PublicAPI.class.getResource("/CustomerCareWS.wsdl");
